<div class="header">
	<div class="header-left"> 
		<a href="index.html" class="logo logo-small">
			<img src="{{asset('theme/assets/img/logo-icon.png')}}" alt="Logo" width="30" height="30">
		</a>
	</div>
	...
	<ul class="nav user-menu">
					...
					<ul class="notification-list">
							...
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="" src="{{asset('theme/assets/img/provider/provider-01.jpg')}}">
									</span>
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="" src="{{asset('theme/assets/img/provider/provider-02.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="" src="{{asset('theme/assets/img/provider/provider-03.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="User Image" src="{{asset('theme/assets/img/provider/provider-04.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="User Image" src="{{asset('theme/assets/img/provider/provider-05.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="User Image" src="{{asset('theme/assets/img/provider/provider-06.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
						...
						<li class="notification-message">
							<a href="admin-notification.html">
								<div class="media">
									<span class="avatar avatar-sm">
										<img class="avatar-img rounded-circle" alt="User Image" src="{{asset('theme/assets/img/provider/provider-07.jpg')}}">
									</span>
									<div class="media-body">
										<p class="noti-details">
		...
		<li class="nav-item dropdown">
			<a href="javascript:void(0)" class="dropdown-toggle user-link  nav-link" data-toggle="dropdown">
				<span class="user-img">
					<img class="rounded-circle" src="{{asset('theme/assets/img/user.jpg')}}" width="40" alt="Admin">
				</span>
			</a>
